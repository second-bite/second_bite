...
const RestaurantTiles = () => {
    const {base_url, setRestaurants, displayed_restaurants, setDisplayedRestaurants, searched_address} = useContext(AppContext)
    ...
    // TODO: Set this up so that recommended restaurants appear when distance is input & disappears on search and/or sort
    // - Need globally scoped address state variable
    // - Need globally scoped "is_recommended_visible" variable
    // useEffect(() => {
